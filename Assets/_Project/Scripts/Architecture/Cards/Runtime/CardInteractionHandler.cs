...
namespace _Project.Scripts.Architecture.Cards.Runtime
{
    ...
    public class CardInteractionHandler : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData) => OnCardClicked?.Invoke(this, _cardUi);
